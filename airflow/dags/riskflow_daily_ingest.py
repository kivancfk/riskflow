"""RiskFlow — daily bronze ingestion DAG (Phase 1, v3).

Changelog:
  v3: removed env_vars={"PYTHONPATH": "/opt/transformations"} since
      bronze_ingest.py is now self-contained
  v2: removed fs_conn_id, simplified Param, fixed FileSensor filepath
  v1: initial version
...
def _record_pipeline_run(**context) -> None:
    ...
    day_param = (dag_run.conf or {}).get("day", "??")
